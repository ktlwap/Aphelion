...
internal sealed class TextRenderScene : BaseScene
{
    public const int ScreenWidth = 1000;
    public const int ScreenHeight = 700;

    private const string Roboto = "Assets/Fonts/Roboto/Roboto-VariableFont_wdth,wght.ttf";
    private const string BlackOps = "Assets/Fonts/Black_Ops_One/BlackOpsOne-Regular.ttf";
    private const string Playwrite = "Assets/Fonts/Playwrite_AU_VIC_Guides/PlaywriteAUVICGuides-Regular.ttf";
    ...
    public override void Start()
    {
        ...
        AddText("Roboto18", new Vector2(40, 210),
            "Roboto 18px — the quick brown fox jumps over the lazy dog", Roboto, 18f, Color.PaleTurquoise);
        AddText("Roboto28", new Vector2(40, 260), "Roboto 28px — the quick brown fox", Roboto, 28f,
            Color.PaleTurquoise);
        ...
        AddText("BlackOps24", new Vector2(40, 490), "Black Ops 24px — MISSION BRIEFING", BlackOps, 24f,
            Color.OrangeRed);
    ...
    private static void AddText(string name, Vector2 position, string text, string fontPath, float fontSize,
        Color color)
    {
