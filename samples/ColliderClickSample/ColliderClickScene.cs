...
internal sealed class ColliderClickScene : BaseScene
{
    ...
    public override void Start()
    {
        ...
        clickHandler.ScreenWidth = ScreenWidth;
        clickHandler.ScreenHeight = ScreenHeight;
    ...
    private static void AddBackground(Vector2 position, Vector2 size, Color color)
    {
    ...
    private static void AddClickableRectangle(string name, Vector2 position, Vector2 size, Color normal)
    {
